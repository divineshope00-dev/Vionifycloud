            ...
            {checkStatus === 'failed' && (
              <div className="w-full mt-4 p-3 rounded-2xl bg-zinc-950 border border-zinc-800 text-left">
                <p className="text-xs text-red-400/80 leading-relaxed">
                  {language === 'fr'
                    ? "Le paiement n'a pas encore été reçu. Veuillez vous assurer que votre paiement est complété via Lemon Squeezy avant de réessayer."
                    : "Payment has not been received yet. Please make sure your payment has been completed via Lemon Squeezy before trying again."}
                </p>
              </div>
            )}
          </div>
